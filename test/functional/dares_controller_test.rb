...
class DaresControllerTest < ActionController::TestCase
  ...
  test "should create dare" do
    assert_difference('Dare.count') do
      post :create, dare: { imageurl: @dare.imageurl, rating: @dare.rating, text: @dare.text, title: @dare.title }
    end
  ...
  test "should update dare" do
    put :update, id: @dare, dare: { imageurl: @dare.imageurl, rating: @dare.rating, text: @dare.text, title: @dare.title }
    assert_redirected_to dare_path(assigns(:dare))
  end
